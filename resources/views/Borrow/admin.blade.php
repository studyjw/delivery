    ...
    $.ajax({
        ...
        success:function (data) {
            for (var i = data.length - 1; i >= 0; i--) {
                var html1 = '<tr><td>' + data[i].id + '</td><td>' + data[i].receiver + '</td><td>' + data[i].site + '</td><td>' + data[i].tel + '</td><td>' + data[i].goods + '</td><td>' + data[i].number + '</td><td>' + data[i].weight + '</td><td>' + data[i].sale + '</td><td>' + data[i].order_time + '</td><td>' + data[i].enddate + '</td><td class="td-status">';
                if (data[i].status == 0) {
